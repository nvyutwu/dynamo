...
pub(super) struct WorkerSelection {
    ...
    pub(super) selected_overlap_blocks: u64,
    pub(super) max_overlap_blocks: u64,
    pub(super) eligible_prefix_blocks: u64,
    pub(super) selected_prefix_blocks: u64,
    ...
    async fn select_best_match(&self, args: BestMatchArgs<'_>) -> Result<WorkerSelection, Error> {
        ...
        match outcome {
            FindBestMatchOutcome::Routed {
                ...
                max_overlap_blocks,
                eligible_prefix_blocks,
                selected_prefix_blocks,
                cached_tokens,
