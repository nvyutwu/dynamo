...
pub fn monitor_for_disconnects(
    ...
    monitor_for_disconnects_with_timeout_and_activity(
        stream,
        context,
        inflight_guard,
        stream_handle,
...
fn monitor_for_disconnects_with_timeout_and_activity(
    stream: impl Stream<Item = Result<Event, axum::Error>>,
    context: Arc<dyn AsyncEngineContext>,
    mut inflight_guard: InflightGuard,
    mut stream_handle: ConnectionHandle,
...
mod tests {
    ...
    async fn test_activity_signal_resets_inactivity_timeout() {
        ...
        let monitored = monitor_for_disconnects_with_timeout_and_activity(
            hanging_stream(),
            engine_context,
            guard,
            handle,
